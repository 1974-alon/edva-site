const translations = {
    ...
    he: {
      ...
      valueProp: {
        ...
        text: 'עשרות שנות נסיון ומומחיות בהובלה וליווי של עסקאות ותהליכים מורכבים עבור חברות טכנולוגיות וסטארטאפים, משקיעים ורוכשים, תוך מעורבות מלאה בכל שלבי התהליך ועד להשלמת העסקה, בין לקוחותינו עשרות חברות ומאות משקיעים ורוכשים פוטנציאלים.'
      },
      about: {
      ...
      services: {
        ...
        item5: 'הכנה מקיפה וניהול תהליך העסקה',
        item6: 'ייעוץ מקצועי לחברות ציבוריות כהמשך למיזוג או הנפקה'
      },
      execution: {
        title: 'סוגרים עסקאות',
      ...
      contact: {
        ...
        emailTitle: 'אימייל', phoneTitle: 'טלפון', locationTitle: 'מיקום', locationText: 'תל אביב, ישראל.',
